...
module "frontdoors" {
  source     = "git::https://github.com/AeternaModules/azurerm_frontdoor.git?ref=v5.0.0"
  frontdoors = local.frontdoors
}

module "frontdoor_rules_engines" {
  source                  = "git::https://github.com/AeternaModules/azurerm_frontdoor_rules_engine.git?ref=v5.0.0"
